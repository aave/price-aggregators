...
* @author Aave 
*/
contract CurvePriceProvider is ICurvePriceProvider {
    ...
    constructor(IPriceOracleGetter aaveOracle, address token, uint256 platformId, address[] memory subTokens) public {
